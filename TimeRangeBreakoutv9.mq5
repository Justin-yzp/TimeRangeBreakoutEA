...
void DrawRangeRectangle()
{
   ...
   rectangleID = ObjectCreate(0, "RangeRectangle", OBJ_RECTANGLE, 0, StartTime, rangeHigh, EndTime, rangeLow);
   ObjectSetInteger(0, "RangeRectangle", OBJPROP_COLOR, clrBlue);
   ObjectSetInteger(0, "RangeRectangle", OBJPROP_STYLE, STYLE_DASH);
   ObjectSetInteger(0, "RangeRectangle", OBJPROP_WIDTH, 1);
   ObjectSetInteger(0, "RangeRectangle", OBJPROP_FILL, false);
   ObjectSetInteger(0, "RangeRectangle", OBJPROP_BACK, true);
}